...
def countFingers(image, results, random_number,counter,status,draw=True, display=True):
    '''
...
def return_to_rasa ( variable , duration) : 
    return (str(variable) , duration )

return_to_rasa (variable , duration )
