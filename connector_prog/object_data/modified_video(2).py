...
lst1 = ["bottle","sports ball","cell phone"]
lst2 = ["Cylindrical","Sphere","Rectangular"]
choose = (random.choice(lst1+lst2))
classes = []
...
while(True):
    ...
    cv2.putText(frame, "Please find this Item: " + choose, (0, 25), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 255))
